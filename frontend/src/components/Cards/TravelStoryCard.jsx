...
const TravelStoryCard = ({ imageUrl, title, date, story, visitedLocation, isFavorite, onFavoriteClick, onClick }) => {
    return (
        <div className='border rounded-lg overflow-hidden bg-white hover:shadow-lg hover:shadow-slate-200 transition-all ease-in-out relative cursor-pointer'>
            <img className='w-full h-56 object-cover rounded-lg' onClick={onClick} src={imageUrl} alt={title} />
